export const rakIccOffshoreData = {
  ...
  benefits_and_incentives: {
    privacy_and_security: [
      "No public register of shareholders or directors (high confidentiality)",
      "Strongest asset protection framework in the region",
  ...
  specialized_entity_types: [
    "Company Limited by Shares (Most common for trading/holding)",
    "Segregated Portfolio Company (SPC): Ring-fences assets and liabilities of different portfolios",
    "Restricted Purposes Company (RPC): Ideal for special purpose vehicles (SPVs) in finance",
    "RAK ICC Foundation: Used for legacy planning, private wealth, and charitable purposes",
    "Premium Product: A hybrid allow-onshore setup in collaboration with RAKEZ for UAE operations"
  ],
